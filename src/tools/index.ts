/**
 * MCP tools — 15종 (plan.md §2 Tools).
 *
 * 카테고리:
 *  - 세션:   session_init
 *  - 글:     publish_post / update_post / delete_post / fetch_post / search_posts
 *  - 자산:   upload_image
 *  - 스킨:   fetch_skin / apply_skin / apply_skin_settings / preview_skin / skin_validate
 *  - 메타:   fetch_meta / categories_update
 *  - 보조:   screenshot
 *
 * `src/index.ts` 에서 `registerTools(server)` 한 줄 호출하면 15개 다 붙는다.
 */
...
import { registerFetchSkin } from "./fetch_skin.js";
