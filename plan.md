...
tistory-mcp/
  ...
  src/
    ...
    tistory/
      ...
      api.ts              # cookie-auth fetch 래퍼. 12개 endpoint (스킨5 + 글5 + 메타1 + 카테고리 batch1).
