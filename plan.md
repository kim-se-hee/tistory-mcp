...
| `tistory_delete_post`         | `postId` (or `postUrl`)                                                                                                                                | `DELETE /manage/post/{id}.json` fetch 1방. 숫자 `postId` 직행 (순회 없음); `postUrl`/slogan 만 주어지면 page slogan 우회 위해 `posts.json` 순회로 실제 id 매칭                                                                                                                                            |
